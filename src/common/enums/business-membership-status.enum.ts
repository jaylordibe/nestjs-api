...
export enum BusinessMembershipStatus {
  // Invited but not yet accepted. Reserves the (business, user) slot so the
  // same person cannot be invited twice or invited while already on the
  // roster. Grants nothing.
  INVITED = 'invited',
  ACTIVE = 'active',
